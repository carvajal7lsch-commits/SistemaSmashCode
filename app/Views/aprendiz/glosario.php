...
<head>
  ...
  <title>Glosario — SmashCode Enfermería SENA</title>
  ...
  <main class="contenido-principal">
    <div class="module-view">
        <div class="module-header">
            ...
            <div>
                <h1>Glosario Médico</h1>
                <p>Tu diccionario de referencia para términos clínicos en inglés.</p>
            </div>
        </div>
        <div style="text-align: center; color: var(--texto-tenue); padding: 50px;">
            <i class="fas fa-tools" style="font-size: 48px; margin-bottom: 20px; color: var(--duo-gray-dark);"></i>
            <h2>Módulo en construcción</h2>
            <p>Pronto podrás buscar términos aquí.</p>
        </div>
    </div>
  </main>
</div>
