...
<head>
  ...
  <title>Diálogos — SmashCode Enfermería SENA</title>
    ...
    <div class="module-view">
        <div class="module-header">
            ...
            <div>
                ...
                <p>Práctica de conversaciones reales con pacientes anglófonos.</p>
            </div>
        </div>
        <div style="text-align: center; color: var(--texto-tenue); padding: 50px;">
            ...
            <p>Pronto podrás interactuar en diálogos simulados aquí.</p>
        </div>
    </div>
  </main>
</div>
