...
<head>
  ...
  <style>
    ...
    .vocab-card { border: 2px solid var(--duo-gray); border-radius: 15px; padding: 20px; display: flex; align-items: center; gap: 15px; background: var(--blanco); transition: transform 0.2s; position: relative; }
    ...
    .vocab-spanish { font-size: 14px; margin: 0; color: var(--texto-tenue); }
  </style>
</head>
<body>
